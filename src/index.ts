...
async function startBot() {
  ...
  if (!config.fireflyConfig || !config.fireflyConfig.baseUrl || !config.fireflyConfig.accessToken) {
    console.error('Ошибка: Не указаны параметры для финансового сервиса (Firefly)')
    process.exit(1)
  }
